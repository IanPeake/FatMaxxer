...
FatMaxxer now provides experimental 10s ECG snapshot around all detected artifacts with Developer mode is enabled: (http://www.muscleoxygentraining.com/2021/07/ecg-artifact-strips-from-fatmaxxer-guide.html).
